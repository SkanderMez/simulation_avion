...
public class SimulationConfig extends Configuration {
    ...
    public List<UsineSimulation> getUsinesSimulationInstances()throws ParserConfigurationException, SAXException, IOException {
     ...
     NodeList usines=metadonneeConfig.recupererUsines("simulation","usine");
    ...
    public void getCheminInstances()throws ParserConfigurationException, SAXException, IOException {
        List<Chemin> cheminObjectList = new ArrayList<>();
        NodeList chemins = metadonneeConfig.recupererUsines("simulation", "chemins");
